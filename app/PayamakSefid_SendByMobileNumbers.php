...
{
    /**    * Send By Mobile Numbers Url.    *    * @return string Indicates the Url */
    ...
    /**    * Send By Mobile Numbers.    *    * @param string $SendData Send Data    * @return string Indicates the Send By Mobile Numbers result */
